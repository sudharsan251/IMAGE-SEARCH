const accesskey = "xKT2ngJPSOo1B2Ch9bemY0OtT5JeSpYE749zJnpevtY";  
...
async function searchImages(){
    ...
    if (data.total_pages > page) {
        showMoreBtn.style.display = "block";  // Show button only if more pages are available
    } else {
        showMoreBtn.style.display = "none";  // Hide button if no more pages
    }
}
